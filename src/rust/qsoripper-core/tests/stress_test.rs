//! Adversarial stress test: hunt for panics in the `QsoRipper` engine.
//!
...
async fn hammer_lookup_coordinator() -> Vec<PanicReport> {
    use qsoripper_core::lookup::coordinator::{LookupCoordinator, LookupCoordinatorConfig};
    use qsoripper_core::lookup::provider::{CallsignProvider, ProviderLookup, ProviderLookupError};
        ...
        async fn lookup_callsign(
            ...
            match n % 4 {
                ...
                1 => Ok(ProviderLookup::found(
                    qsoripper_core::proto::qsoripper::domain::CallsignRecord {
                        callsign: "TEST".into(),
